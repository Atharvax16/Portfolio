    ...
    <>
      <style>{`
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        body{background:#F2F1EC;color:#16181D;font-family:'Source Serif 4',Georgia,serif;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility}
      ...
      <div style={{ width: "100%", minHeight: "100vh", background: P.paper, color: P.ink, position: "relative" }}>
        ...
        {/* RUNNING HEAD */}
        <header style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, padding: "0.6rem 1.4rem", display: "flex", justifyContent: "space-between", alignItems: "center", background: "rgba(242,241,236,0.88)", backdropFilter: "blur(8px)", borderBottom: `1px solid ${P.line}` }}>
